...
const PetCare = () => {
    return (
        <div className='w-11/12 mx-auto my-10  '>
            <h3 className='text-5xl font-extrabold text-black '>Cold Weather Safety Tips</h3>
            ...
            <div className='w-10/12 mx-auto my-5'>
                <ol className='list-decimal grid grid-cols-1 gap-5 text-black-300 text-[20px] text-black'>
            ...
            <p className='text-3xl text-black font-semibold pb-5'>Be sure to keep these tips top of mind this winter so that you and your furry friends can stay warm, cozy and safe.
